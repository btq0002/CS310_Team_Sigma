...
public class LexerTests {
	...
	public static java.util.Collection<Object[]> data() {
		return java.util.Arrays.asList(new Object[][]{
			...
			{ "LET p = TRUE;  QUERY ~(~p)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY NEGATION OPEN_PAREN NEGATION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; QUERY ~(~p)." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY NEGATION OPEN_PAREN NEGATION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = TRUE;  QUERY (p)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; QUERY (p)." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = TRUE;  QUERY ((p))." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY OPEN_PAREN OPEN_PAREN VARIABLE_NAME CLOSE_PAREN CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; QUERY ((p))." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY OPEN_PAREN OPEN_PAREN VARIABLE_NAME CLOSE_PAREN CLOSE_PAREN END_QUERY" },
			
			{ "LET p = TRUE;  LET q = TRUE;  QUERY ~(p & q) <=> (~p | ~q)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY NEGATION OPEN_PAREN VARIABLE_NAME CONJUNCTION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION NEGATION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = TRUE;  LET q = FALSE; QUERY ~(p & q) <=> (~p | ~q)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY NEGATION OPEN_PAREN VARIABLE_NAME CONJUNCTION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION NEGATION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; LET q = TRUE;  QUERY ~(p & q) <=> (~p | ~q)." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY NEGATION OPEN_PAREN VARIABLE_NAME CONJUNCTION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION NEGATION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			...
			{ "LET p = TRUE;  LET q = TRUE;  QUERY (p -> q) <=> (~p | q)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME IMPLICATION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = TRUE;  LET q = FALSE; QUERY (p -> q) <=> (~p | q)." , "LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME IMPLICATION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; LET q = TRUE;  QUERY (p -> q) <=> (~p | q)." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET LET VARIABLE_NAME ASSIGN TRUE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME IMPLICATION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			{ "LET p = FALSE; LET q = FALSE; QUERY (p -> q) <=> (~p | q)." , "LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET LET VARIABLE_NAME ASSIGN FALSE_LITERAL END_LET QUERY OPEN_PAREN VARIABLE_NAME IMPLICATION VARIABLE_NAME CLOSE_PAREN EQUIVALENCE OPEN_PAREN NEGATION VARIABLE_NAME DISJUNCTION VARIABLE_NAME CLOSE_PAREN END_QUERY" },
			...
			{ "&|QUERY LET P ~)", "CONJUNCTION DISJUNCTION QUERY LET VARIABLE_NAME NEGATION CLOSE_PAREN" },
		});
	}
